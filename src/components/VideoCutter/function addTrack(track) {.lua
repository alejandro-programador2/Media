function addTrack(track) {
  ...
  rep.append($("<div>").append(
    ...
    .on("mousedown touchstart", function(e) {
      ...
      segmentDrag.handle = segmentDrag.target.hasClass("handle");
      ...
      segmentDrag.me = $(this).addClass("dragging");
      
      // La variable "segmentDrag.me" se establece como el elemento actual (el segmento de la pista) en el que se activó el evento (el "mousedown" o "touchstart").
      ...
      segmentDrag.segmentW = segmentDrag.me.outerWidth();
      segmentDrag.segmentH = segmentDrag.me.outerHeight();
      
      // Se guardan las dimensiones (ancho y alto) del segmento de la pista en las variables "segmentDrag.segmentW" y "segmentDrag.segmentH".
      ...
      segmentDrag.cursorY = e.pageY;
      
      // Se guardan las coordenadas del puntero del mouse o del dedo en el momento en que se hizo clic o tocó en el segmento en las variables "segmentDrag.cursorX" y "segmentDrag.cursorY".

      segmentDrag.origVStart = tracks[segmentDrag.me.attr("data-unique")].vstart;
      ...
      if (segmentDrag.handle) {
        segmentDrag.target.addClass("pressed");
      } else {
        segmentDrag.me.addClass("entire");
      }
      
      // Si el usuario hizo clic o tocó en un manija del segmento (segmentDrag.handle es true), se agrega la clase "pressed" al elemento objetivo (el manija).
      ...
      $("body, *").css("cursor", segmentDrag.target.css("cursor"));
